...
let audioElement_1= new Audio('songs/02 Kar Har Maidaan Fateh - Sanju.mp3');
let audioElement_2= new Audio('songs/Bint-e-Dil - (Raag.Fm).mp3');
let audioElement_3= new Audio('songs/04 Sultan - Title Song (Sukhvinder Singh) 190Kbps.mp3');
let audioElement_4= new Audio('songs/Lut_Gaye-Jubin_Nautiyal-(JattZone.com).mp3');
let audioElement_5= new Audio('songs/Give Me Some Sunshine - 3 Idiots Aamir Khan, Madhavan, Sharman J Suraj Jagan Shantanu Moit.mp3');
let audioElement_6= new Audio('songs/KABIR_SINGH_mass_Full_BGM_(_without_remake_)(128k).mp3');


let songs=[
    {songlist: "Kar Har Maidaan Fateh - [Sanju]", filePath:"songs/02 Kar Har Maidaan Fateh - Sanju.mp3" },
    {songlist: "Bint-e-Dil - [Padmaavat]", filePath:"songs/Bint-e-Dil - (Raag.Fm).mp3" },
    {songlist: "Sultan - Title Song", filePath:"songs/04 Sultan - Title Song (Sukhvinder Singh) 190Kbps.mp3" },
    {songlist: "Lut Gaye", filePath:"songs/Lut_Gaye-Jubin_Nautiyal-(JattZone.com).mp3" },
    {songlist: "Give Me Some Sunshine - [3 Idiots]", filePath:"songs/Give Me Some Sunshine - 3 Idiots Aamir Khan, Madhavan, Sharman J Suraj Jagan Shantanu Moit.mp3" },
    {songlist: "Kabir Singh BGM", filePath:"songs/KABIR_SINGH_mass_Full_BGM_(_without_remake_)(128k).mp3" },
]
